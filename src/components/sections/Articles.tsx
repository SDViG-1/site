      ...
      <div className="mx-auto w-full max-w-[1200px] px-6">
        <div className="flex flex-col items-start gap-5 sm:items-center sm:text-center">
          ...
          <motion.h2
            ...
            className="max-w-[22ch] text-[34px] font-semibold leading-[1.05] tracking-[-0.02em] text-white sm:text-[46px] lg:text-[54px]"
          >
            Короткие разборы{" "}
            <span
          ...
          <motion.p
            ...
            className="max-w-[58ch] text-[16px] leading-relaxed text-white/55 sm:text-[17px]"
          >
...
function AllGuidesLink() {
  return (
    <Link
      href="/guides"
      className="group inline-flex items-center gap-2 rounded-full px-1 py-2 text-[15px] font-semibold text-white transition-colors hover:text-[var(--color-teal-300)]"
    >
