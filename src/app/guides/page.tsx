        ...
        <section className="relative pb-24 pt-32 sm:pb-32 sm:pt-40">
          <div className="mx-auto w-full max-w-[1200px] px-6">
            <div className="flex flex-col items-start gap-5 sm:items-center sm:text-center">
              ...
              <h1 className="max-w-[22ch] text-[38px] font-semibold leading-[1.04] tracking-[-0.02em] text-[var(--color-ink)] sm:text-[56px] lg:text-[68px]">
                Библиотека{" "}
                <span
              ...
              <p className="max-w-[60ch] text-[16px] leading-relaxed text-[var(--color-ink)]/55 sm:text-[17.5px]">
